...
**Convertidor online de archivos PSD y AI a PNG/JPG**

Visualizador profesional de archivos Adobe Photoshop (.psd) e Illustrator (.ai) sin necesidad de tener instalado el software. Gratis, rápido, hasta 100MB.

🔗 **https://miralorapido.streamlit.app/**
...
### Funcionalidad
- ✅ **Convierte PSD a PNG/JPG** - Todas las versiones de Photoshop
- ✅ **Convierte AI a PNG/JPG** - Illustrator CS en adelante
- ✅ **Hasta 100MB por archivo** - Optimizado para archivos grandes
- ✅ **Preview instantáneo** - Vista optimizada (1200px max)
- ✅ **Descarga en alta resolución** - Resolución original completa
- ✅ **PNG con transparencias** - Preserva capas alpha
- ✅ **JPG con fondo blanco** - Archivos más livianos

### Diseño Retro 00s
- 🎨 **Estética Windows XP** - Luna Theme auténtico
- 🖱️ **Cursor personalizado** - SVG retro embebido
- 🌗 **Dark mode responsive** - Vista/7 Aero Dark automático
- 📱 **100% responsive** - Desktop, tablet, mobile
- 🇦🇷 **Español argentino** - Voseo natural y directo

### SEO Optimizado
- 🔍 Meta tags completos para Google
...
1. Visita **https://miralorapido.streamlit.app/**
2. Arrastrá tu archivo .psd o .ai
3. Visualizá y descargá (PNG o JPG)
...
```python
MAX_FILE_SIZE_MB = 100       # Límite de tamaño de archivo
...
### Light Mode (Windows XP Luna)
- **Background:** `#ece9d8` (Gris Luna)
- **Azul Principal:** `#0054e3` (Barra de título)
- **Azul Oscuro:** `#003db3` (Texto importante)
- **Bordes 3D:** `#b0b0b0` / `#606060`

### Dark Mode (Vista/7 Aero Dark)
- **Background:** `#1a1a1a`
- **Azul Header:** `#1e3a5f` → `#2a5a8f`
- **Azul Accent:** `#5fa5ff`
- **Cards:** `#3a3a3a` → `#2a2a2a`
...
Ver archivo completo: [`CAMBIOS.md`](./CAMBIOS.md)

### v1.3 (2026-01-29) - ACTUAL
- ✅ Diseño retro Windows XP completo
- ✅ UX optimizado (above the fold)
- ✅ Español argentino 100%
- ✅ SEO optimization
- ✅ Dark mode responsive
- ✅ Cursor personalizado retro
- ✅ Fix descarga PNG/JPG
- ✅ Límite aumentado a 100MB

---

**⚡ MIRALO RÁPIDO** - El conversor que no te olvidás
